...
with tab_model:
    ...
    st.subheader("Каскадно натрупване от високи към ниски зони")
    ...
    with c1:
        ...
        params["spill_percent"] = st.slider("Процент на разлив", 0.00, 0.50, float(DEFAULT_MODEL_PARAMS["spill_percent"]), 0.01)
